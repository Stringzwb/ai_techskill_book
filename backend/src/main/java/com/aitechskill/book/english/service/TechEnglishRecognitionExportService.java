...
public class TechEnglishRecognitionExportService {
    ...
    private String html(String sourceName,
        ...
        return """
                ...
                *{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 10% 0,#dce7ff 0,transparent 34%),var(--paper);color:var(--ink);font:15px/1.75 -apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC",sans-serif}
                main{width:min(980px,calc(100% - 32px));margin:42px auto 80px}.hero{padding:36px;border-radius:28px;color:#fff;background:linear-gradient(135deg,#17233e,#3157d5 58%,#0c9b79);box-shadow:0 24px 70px #294da833}.hero small{letter-spacing:.16em;opacity:.8}.hero h1{margin:10px 0 12px;font-size:clamp(28px,5vw,48px);line-height:1.1}.hero p{margin:0;opacity:.86}.stats{display:flex;gap:10px;flex-wrap:wrap;margin-top:24px}.stats span{padding:7px 12px;border:1px solid #ffffff42;border-radius:999px;background:#ffffff14}
