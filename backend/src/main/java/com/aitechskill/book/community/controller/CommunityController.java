...
public class CommunityController {
 ...
 @GetMapping("/posts") public CommunityPostPageResponse list(@RequestParam(required=false) String keyword,@RequestParam(required=false) Long tagId,@RequestParam(defaultValue="1") int page,@RequestParam(defaultValue="12") int size){return service.list(keyword,tagId,page,size,UserContextHolder.requireUserId());}
